...
def render_list(session: Session, default: str, name: str, db: str = 'db') -> Context:
...
def render_catalog_list(session: Session, name: str, db: str = 'db') -> Context:
    return render_list(session, 'Catalog', name, db)


def render_document_list(session: Session, name: str, db: str = 'db') -> Context:
    return render_list(session, 'Document', name, db)


def render_select(session: Session, default: str, name: str, callback: Callable[[Any], None], db: str = 'db') -> Context:
    _ = session.gettext
...
def render_catalog_select(session: Session, name: str, callback: Callable[[Any], None], db: str = 'db') -> Context:
    return render_select(session, 'Catalog', name, callback, db)
